...
In the proposed effort, we will expand upon the current state--of--the--art in event
...
restframe spectral energy distribution (SED) for SNe Ia. Importantly, the
...
(intrinsically bright to intrinsically faint) of Ia. This single representation---mean surface plus a first moment---contains the behaviors and correlations
...
the SALT--II model of \cite{2007A&A...466...11G}.  Restframe SED surfaces are
...
novae \citep{2011ApJ...730..134K}.  The Co-PIs are also involved in proposals
...
give an idea of the scope of the effort we intend to undertake---Figure~\ref{fig:var} provides a representation of this variable menagerie. In
...
observer-frame filter profile into a restframe window. This has the
...
restframe u-band, where ground-based calibration is difficult, by using
...
available.  These models will be defined in the event restframe, and (to the
